...
function loadSets() {
    fetch(`/sets`, { credentials: "include" })
        .then(res => res.json())
        .then(data => {
            allSets = data.sets || [];
            displaySets(allSets);
...
function showSetDetail(id, title, description) {
    ...
    fetch(`/sets/${id}/cards`, { credentials: "include" })
        .then(res => res.json())
        .then(data => {
...
function editCurrentSet() {
    fetch(`/sets/${currentSetId}/cards`, { credentials: "include" })
        .then(res => res.json())
        .then(data => {
...
function saveNewSet() {
    ...
    const url = currentSetId ? `/sets/${currentSetId}` : `/sets`;
